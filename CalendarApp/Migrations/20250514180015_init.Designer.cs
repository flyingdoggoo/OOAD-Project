            ...
            modelBuilder.Entity("CalendarApp.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            EndTime = new DateTime(2025, 5, 16, 10, 0, 0, 0, DateTimeKind.Local),
                            Location = "Office A",
                            Name = "Meeting with Boss",
                            OwnerId = 1,
                            StartTime = new DateTime(2025, 5, 16, 9, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 2,
                            EndTime = new DateTime(2025, 5, 17, 16, 0, 0, 0, DateTimeKind.Local),
                            Location = "Home Office",
                            Name = "Project Deadline Prep",
                            OwnerId = 2,
                            StartTime = new DateTime(2025, 5, 17, 14, 0, 0, 0, DateTimeKind.Local)
                        });
                });
            ...
            modelBuilder.Entity("CalendarApp.Models.Reminder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TriggerTime = new DateTime(2025, 5, 16, 8, 45, 0, 0, DateTimeKind.Local),
                            UserId = 1
                        },
                        new
                        {
                            ...
                            TriggerTime = new DateTime(2025, 5, 17, 13, 30, 0, 0, DateTimeKind.Local),
                            UserId = 2
                        });
                });
            ...
            modelBuilder.Entity("CalendarApp.Models.GroupMeeting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            EndTime = new DateTime(2025, 5, 16, 11, 30, 0, 0, DateTimeKind.Local),
                            Location = "Meeting Room 1",
                            Name = "Team Sync",
                            OwnerId = 1,
                            StartTime = new DateTime(2025, 5, 16, 11, 0, 0, 0, DateTimeKind.Local)
                        });
                });
