    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Appointment", new DateTime(2025, 5, 16, 10, 0, 0, 0, DateTimeKind.Local), "Office A", "Meeting with Boss", 1, new DateTime(2025, 5, 16, 9, 0, 0, 0, DateTimeKind.Local) });

            migrationBuilder.InsertData(
                table: "Appointments",
                columns: new[] { "Id", "Discriminator", "EndTime", "Location", "Name", "OwnerId", "StartTime" },
                values: new object[] { 3, "GroupMeeting", new DateTime(2025, 5, 16, 11, 30, 0, 0, DateTimeKind.Local), "Meeting Room 1", "Team Sync", 1, new DateTime(2025, 5, 16, 11, 0, 0, 0, DateTimeKind.Local) });

            migrationBuilder.InsertData(
                table: "Appointments",
                columns: new[] { "Id", "Discriminator", "EndTime", "Location", "Name", "OwnerId", "StartTime" },
                values: new object[] { 2, "Appointment", new DateTime(2025, 5, 17, 16, 0, 0, 0, DateTimeKind.Local), "Home Office", "Project Deadline Prep", 2, new DateTime(2025, 5, 17, 14, 0, 0, 0, DateTimeKind.Local) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 5, 16, 8, 45, 0, 0, DateTimeKind.Local), 1 },
                    { 2, 2, new DateTime(2025, 5, 17, 13, 30, 0, 0, DateTimeKind.Local), 2 }
                });
